...
# power_new1 = str(datetime.datetime.now().replace(microsecond=0))
# power_new2 = str("2018-04-07 13:03:10")


# time_difference = (datetime.datetime.strptime(power_new1, "%Y-%m-%d %H:%M:%S") - datetime.datetime.strptime(power_new2, "%Y-%m-%d %H:%M:%S")).total_seconds()
